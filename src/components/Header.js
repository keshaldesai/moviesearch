...
function Header() {
	...
	return (
		<div className="header">
			...
			<span className="search-box"><i className="fa fa-search fa-2x" aria-hidden="true"></i><input className="search-input" type="text" name="search" placeholder="Search Movie Title..." /></span>
		</div>
	)
}
